                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full inner_elements">
                                          ...
                                          <div class="tabbar padding_infor_info">
                                             <nav>
                                                <div class="nav nav-tabs" id="nav-tab1" role="tablist">
                                                   ...
                                                   <a class="nav-item nav-link" id="nav-contact-tab2" data-toggle="tab" href="#nav-contact_s2" role="tab" aria-controls="nav-contacts_s2" aria-selected="false">Add Users</a>
                                                </div>
                                             </nav>
                                       ...
                                       <div class="full dis_flex center_text">
                                          ...
                                          <div class="profile_contant">
                                             ...
                                             <div class="contact_inner">
                                                <div class="profile_img"><img width="180" class="rounded-circle" src="../image/profile/<?php echo $p_profile;?>" alt="#" />
                                 ...
                                 <div class="col-md-6 col-lg-3" >
                                       ...
                                       ID:<input type="text" name="id" value="<?php echo $p_id; ?>" required style="width: 200px; height: 35px; border-color: green; border-radius: 10px;" readonly>
                                       Username:<input type="text" name="username" value="<?php echo $p_username; ?>" required style="width: 200px; height: 35px; border-color: green; border-radius: 10px;" readonly>
                                    ...
                                    <div class="center">
                                       ...
                                       <!-- end user profile section -->
                                                ...
                                                <div class="tab-pane fade" id="nav-profile_s2" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                   <div class="dash_head">
                                    <h3><span><i class="fa fa-exchange"></i> Update My Profile</span>
                                 </div>
